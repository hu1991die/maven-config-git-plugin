...
### 8、使用maven
```
mvn clean install -Dmaven.test.skip=true -Pprod -DgitUrl=${gitUrl} -DgitUserName=${gitUserName} -DgitPassword=${gitPassword} -DgitLocalPath=${gitLocalPath} -DgitConfigPath=${gitConfigPath}
```

#### 8.1、使用实例：
```
mvn clean install -Dmaven.test.skip=true -Pprod -DgitUrl="xxx" -DgitUserName="xxx" -DgitPassword="xxx" -DgitLocalPath="xxx" -DgitConfigPath="xxx"
```